...
:root {
  ...
  --font-abcfavoritvariable:
    "Abcfavoritvariable", ui-sans-serif, system-ui, -apple-system,
    BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
  --font-martinaplantijn:
    "Martinaplantijn", ui-sans-serif, system-ui, -apple-system,
    BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
